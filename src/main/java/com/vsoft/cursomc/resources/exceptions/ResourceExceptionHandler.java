...
import com.vsoft.cursomc.services.exception.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataIntegrityExceptionResponseEntity(MethodArgumentNotValidException e, HttpServletRequest request) {
